  ...
  void solarSimulation() {
    if (calculatorFormKey.currentState.validate()) {
      ...
      if (_selectedInclination == 0) {
        ...
        factor = 88;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= -80 && _selectedAzimut <= -70)) {
        factor = 89;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= -65 && _selectedAzimut <= -55)) {
        factor = 90;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= -50 && _selectedAzimut <= -10)) {
        factor = 91;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 5)) {
        factor = 92;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= 10 && _selectedAzimut <= 45)) {
        factor = 91;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= 50 && _selectedAzimut <= 60)) {
        factor = 90;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= 65 && _selectedAzimut <= 75)) {
        factor = 91;
      } else if (_selectedInclination == 5 && _selectedAzimut == 80) {
        factor = 90;
      } else if (_selectedInclination == 5 &&
          (_selectedAzimut >= 85 && _selectedAzimut <= 90)) {
        factor = 89;
      }
      ...
      //helling 10
        ...
        factor = 90;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= -80 && _selectedAzimut <= -70)) {
        factor = 91;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= -65 && _selectedAzimut <= -60)) {
        factor = 92;
      } else if (_selectedInclination == 10 && _selectedAzimut == -55) {
        factor = 93;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= -50 && _selectedAzimut <= -40)) {
        factor = 94;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= -35 && _selectedAzimut <= -10)) {
        factor = 95;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 5)) {
        factor = 96;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= 10 && _selectedAzimut <= 35)) {
        factor = 95;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= 40 && _selectedAzimut <= 50)) {
        factor = 94;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= 55 && _selectedAzimut <= 65)) {
        factor = 93;
      } else if (_selectedInclination == 10 && _selectedAzimut == 70) {
        factor = 92;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= 75 && _selectedAzimut <= 80)) {
        factor = 91;
      } else if (_selectedInclination == 10 &&
          (_selectedAzimut >= 85 && _selectedAzimut <= 90)) {
        factor = 90;
      ...
      //helling 15
        ...
        factor = 90;
      } else if (_selectedInclination == 15 &&
          (_selectedAzimut >= -80 && _selectedAzimut <= -70)) {
        factor = 91;
      } else if (_selectedInclination == 15 &&
          (_selectedAzimut >= -65 && _selectedAzimut <= -60)) {
        ...
        factor = 95;
          ...
          (_selectedAzimut >= -35 && _selectedAzimut <= -25)) {
        factor = 96;
      } else if (_selectedInclination == 15 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= 20)) {
        factor = 97;
      } else if (_selectedInclination == 15 &&
          (_selectedAzimut >= 25 && _selectedAzimut <= 35)) {
        factor = 96;
      } else if (_selectedInclination == 15 &&
          (_selectedAzimut >= 40 && _selectedAzimut <= 50)) {
        factor = 95;
      } else if (_selectedInclination == 15 &&
          (_selectedAzimut >= 55 && _selectedAzimut <= 60)) {
        factor = 94;
      ...
      //helling 20
        ...
        factor = 95;
      } else if (_selectedInclination == 20 &&
          (_selectedAzimut >= -45 && _selectedAzimut <= -40)) {
        factor = 96;
      } else if (_selectedInclination == 20 &&
          (_selectedAzimut >= -35 && _selectedAzimut <= -25)) {
        factor = 97;
      ...
      //helling 25
        ...
        factor = 97;
      } else if (_selectedInclination == 25 &&
          (_selectedAzimut >= -35 && _selectedAzimut <= -30)) {
        factor = 98;
      } else if (_selectedInclination == 25 &&
          (_selectedAzimut >= -25 && _selectedAzimut <= 20)) {
        factor = 99;
      } else if (_selectedInclination == 25 && _selectedAzimut == 25) {
        factor = 98;
      } else if (_selectedInclination == 25 &&
          (_selectedAzimut >= 30 && _selectedAzimut <= 40)) {
        factor = 97;
      } else if (_selectedInclination == 25 &&
          (_selectedAzimut >= 45 && _selectedAzimut <= 50)) {
        factor = 96;
      } else if (_selectedInclination == 25 && _selectedAzimut == 55) {
        factor = 95;
      } else if (_selectedInclination == 25 && _selectedAzimut == 60) {
      ...
      //helling 30
        ...
        factor = 97;
      } else if (_selectedInclination == 30 &&
          (_selectedAzimut >= -35 && _selectedAzimut <= -25)) {
        factor = 98;
      } else if (_selectedInclination == 30 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 99;
      } else if (_selectedInclination == 30 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
        factor = 100;
      } else if (_selectedInclination == 30 && _selectedAzimut == 25) {
        factor = 99;
      } else if (_selectedInclination == 30 &&
          (_selectedAzimut >= 30 && _selectedAzimut <= 35)) {
        factor = 98;
      } else if (_selectedInclination == 30 && _selectedAzimut == 40) {
        factor = 97;
      } else if (_selectedInclination == 30 &&
      ...
      //helling 35
        ...
        factor = 97;
      } else if (_selectedInclination == 35 &&
          (_selectedAzimut >= -35 && _selectedAzimut <= -25)) {
        factor = 98;
      } else if (_selectedInclination == 35 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
      ...
      //helling 40
        ...
        factor = 96;
      } else if (_selectedInclination == 40 &&
          (_selectedAzimut >= -35 && _selectedAzimut <= -30)) {
        factor = 97;
        ...
        factor = 100;
          ...
          (_selectedAzimut >= 10 && _selectedAzimut <= 20)) {
        factor = 99;
      } else if (_selectedInclination == 40 &&
          (_selectedAzimut >= 25 && _selectedAzimut <= 35)) {
        factor = 98;
      ...
      //helling 45
        ...
        factor = 97;
      } else if (_selectedInclination == 45 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 98;
      } else if (_selectedInclination == 45 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 5)) {
      ...
      //helling 50
        ...
        factor = 95;
      } else if (_selectedInclination == 50 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 96;
      } else if (_selectedInclination == 50 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
        factor = 97;
          ...
          (_selectedAzimut >= 25 && _selectedAzimut <= 30)) {
        factor = 96;
      } else if (_selectedInclination == 50 && _selectedAzimut == 35) {
        factor = 95;
      } else if (_selectedInclination == 50 && _selectedAzimut == 40) {
      ...
      //helling 55
        ...
        factor = 93;
      } else if (_selectedInclination == 55 &&
          (_selectedAzimut >= -25 && _selectedAzimut <= -15)) {
        factor = 94;
      } else if (_selectedInclination == 55 &&
          (_selectedAzimut >= -10 && _selectedAzimut <= 15)) {
        factor = 95;
      } else if (_selectedInclination == 55 &&
          (_selectedAzimut >= 20 && _selectedAzimut <= 25)) {
        factor = 94;
      } else if (_selectedInclination == 55 && _selectedAzimut == 30) {
        factor = 93;
      } else if (_selectedInclination == 55 && _selectedAzimut == 35) {
      ...
      //helling 60
        ...
        factor = 92;
      } else if (_selectedInclination == 60 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
        factor = 93;
      ...
      //helling 65
        ...
        factor = 88;
      } else if (_selectedInclination == 65 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 89;
      } else if (_selectedInclination == 65 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
      ...
      //helling 70
        ...
        factor = 85;
      } else if (_selectedInclination == 70 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 86;
      } else if (_selectedInclination == 70 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
      ...
      //helling 75
        ...
        factor = 82;
      } else if (_selectedInclination == 75 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 83;
      } else if (_selectedInclination == 75 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
      ...
      //helling 80
        ...
        factor = 78;
      } else if (_selectedInclination == 80 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 79;
      } else if (_selectedInclination == 80 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
      ...
      //helling 85
        ...
        factor = 74;
      } else if (_selectedInclination == 85 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= -10)) {
        factor = 75;
      } else if (_selectedInclination == 85 &&
          (_selectedAzimut >= -5 && _selectedAzimut <= 20)) {
      ...
      //helling 90
        ...
        factor = 70;
      } else if (_selectedInclination == 90 &&
          (_selectedAzimut >= -20 && _selectedAzimut <= 35)) {
        factor = 71;
      } else if (_selectedInclination == 90 && _selectedAzimut == 40) {
        factor = 70;
      } else if (_selectedInclination == 90 && _selectedAzimut == 45) {
      ...
      int estimatedPower =
          (maxPower * (factor / 100) * (location / 100)).round();

      setState(() {
        //textToShow = "$panels + $inclination +$azimut +$_selectedLocation +$_selectedWattPeak = $result";
        textToShowMaxPower =
            "Maximum power: $panels * $wattPeak = $maxPower Wp";
        textToShowEstimatedPower =
            "Estimated power: ($maxPower * ($factor/100) *($location/100)) = $estimatedPower kWh/year";
      });
    }
  }
}

class SimulationPageTopPart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "Calculate the estimated solar power.",
                style: Styles.h2,
