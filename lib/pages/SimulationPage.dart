  ...
  void solarSimulation() {
    ...
    //helling 90
      ...
      setState(() {
        ...
        textToShowMaxPower = "Maximum power: $panels * $wattPeak = $maxPower Wp";
        textToShowEstimatedPower = "Estimated power: ($maxPower * ($factor/100) *($location/100)) = $estimatedPower kWh/year";
      });
    }
  }
}
